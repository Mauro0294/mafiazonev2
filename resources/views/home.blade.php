...
<body class="bg-center bg-no-repeat bg-cover m-0 overflow-hidden p-0">
    <ul class='bg-black flex items-center justify-between h-12 m-0 overflow-hidden pl-12 text-white w-full'>
        ...
        <div class='hide gap-8 flex text-lg'>
    ...
    <div class='flex flex-col justify-center py-0 px-6 relative h-5/6'>
        <div>
            ...
            <div class='flex justify-center'><a href='register'><button>Create account.</button></a></div>
        </div>
    </div>
</body>
</html>
